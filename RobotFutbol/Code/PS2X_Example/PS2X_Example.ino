 ...
 if(error == 1) //skip loop if no controller found
  return; 
    ...
    if(ps2x.ButtonReleased(PSB_PINK))  
        digitalWrite(10,LOW); digitalWrite(15,LOW);digitalWrite(14,LOW); digitalWrite(16,LOW);
    ...
    if(ps2x.NewButtonState(PSB_BLUE)) 
     digitalWrite(10,HIGH);  digitalWrite(15,LOW);      digitalWrite(16,LOW);digitalWrite(14,HIGH);

       analogWrite(3,255); analogWrite(9,255);
